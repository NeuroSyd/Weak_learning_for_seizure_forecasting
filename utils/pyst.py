...
def read_edf_elec(edf_fn, parameters = "params_common_electrodes.txt"):
    ...
    #
    fsamp, sig, labels = nedc_load_edf(edf_fn)
    #fsamp, sig, labels = mne_load_edf(edf_fn)
    # select channels from parameter file
    #
    #print(labels)
    fsamp_sel, sig_sel, labels_sel = nedc_select_channels(params,
...
if __name__ == "__main__":
    parameters = "params_common_electrodes.txt"
    edf_fn = '/mnt/data4/datasets/seizure/TUH_EEG_Seizure/v1.5.1/ICA/train/01_tcp_ar/077/00007773/00007773_s003_t002_icalbl.edf'
    # fsamp, data = read_edf(edf_fn, parameters)
    fsamp,data = mne_load_edf(edf_fn)
